...
{
    /// <summary>
    /// Interaction logic for PositionAnalyzerView.xaml
    /// </summary>
    public partial class PositionAnalyzerView : ThemedWindow
    {
        private const string MODULE_NAME = "Position Analyzer";
        ...
        public PositionAnalyzerView() : this(Guid.NewGuid().ToString())
        {
        }

        public PositionAnalyzerView(string uid)
        {
            Uid = uid;
            InitializeComponent();
            Name = nameof(PositionAnalyzerView);
            ...
            Module = Module.PositionAnalyzer;
        ...
        {
            PositionAnalyzerViewModel viewModel = (PositionAnalyzerViewModel)DataContext;
            viewModel.Dispose();
        }
        ...
        private void SetTitleFromConfigSave(ConfigSave configSave)
        {
            ...
            {
                if (DataContext is PositionAnalyzerViewModel viewModel)
                {
