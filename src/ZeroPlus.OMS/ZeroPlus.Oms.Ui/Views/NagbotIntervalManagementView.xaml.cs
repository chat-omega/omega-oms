...
{
    /// <summary>
    /// Interaction logic for NagbotIntervalManagementView.xaml
    /// </summary>
    public partial class NagbotIntervalManagementView : ThemedWindow
    {
        public NagbotIntervalManagementView()
        {
            InitializeComponent();
        }
