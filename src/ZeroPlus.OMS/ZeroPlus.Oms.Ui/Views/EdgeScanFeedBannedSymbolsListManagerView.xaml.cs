...
{
    /// <summary>
    /// Interaction logic for EdgeScanFeedBannedSymbolsListManagerView.xaml
    /// </summary>
    public partial class EdgeScanFeedBannedSymbolsListManagerView : ThemedWindow
    {
        public EdgeScanFeedBannedSymbolsListManagerView()
        {
            InitializeComponent();
        }
