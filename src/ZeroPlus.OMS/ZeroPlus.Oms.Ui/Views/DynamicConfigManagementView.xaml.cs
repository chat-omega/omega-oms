...
{
    /// <summary>
    /// Interaction logic for DynamicConfigManagementView.xaml
    /// </summary>
    public partial class DynamicConfigManagementView : ThemedWindow
    {
        public DynamicConfigManagementView()
        {
            InitializeComponent();
            Loaded += OnViewLoaded;
        }
        ...
        {
            if (DataContext is DynamicConfigManagementViewModel viewModel)
            {
