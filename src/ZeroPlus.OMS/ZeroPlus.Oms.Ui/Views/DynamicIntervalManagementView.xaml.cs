...
{
    /// <summary>
    /// Interaction logic for DynamicIncrementManagementView.xaml
    /// </summary>
    public partial class DynamicIntervalManagementView : ThemedWindow
    {
        public DynamicIntervalManagementView()
        {
            InitializeComponent();
        }
