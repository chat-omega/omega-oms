...
{
    /// <summary>
    /// Interaction logic for MlTradersControlView.xaml
    /// </summary>
    public partial class MlTradersControlView : ThemedWindow
    {
        private const string MODULE_NAME = "Model Trader Control";
        ...
        public MlTradersControlView() : this(Guid.NewGuid().ToString())
        {
        }

        public MlTradersControlView(string uid)
        {
            Uid = uid;
            InitializeComponent();
            Name = nameof(MlTradersControlView);
            ...
            Module = Module.MlTradersControlLayout;
        ...
        {
            MlTradersControlViewModel viewModel = (MlTradersControlViewModel)DataContext;
            viewModel.Dispose();
        }
        ...
        private void SetTitleFromConfigSave(ConfigSave configSave)
        {
            ...
            {
                if (DataContext is MlTradersControlViewModel viewModel)
                {
