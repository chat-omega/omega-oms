...
public partial class TreeSpreadsGeneratorSettingsModel : BindableBase, ITreeSpreadsGeneratorSettings
{
    ...
    public TreeSpreadsGeneratorSettingsModel Clone()
    {
        return new TreeSpreadsGeneratorSettingsModel()
        {
