...
{
    public partial class VerticalSpreadsGeneratorSettingsModel : BindableBase, IVerticalSpreadsGeneratorSettings
    {
        ...
        public VerticalSpreadsGeneratorSettingsModel Clone()
        {
            return new VerticalSpreadsGeneratorSettingsModel()
            {
