...
{
    public partial class ButterflySpreadsGeneratorSettingsModel : BindableBase, IButterflySpreadsGeneratorSettings
    {
        ...
        public ButterflySpreadsGeneratorSettingsModel Clone()
        {
            return new ButterflySpreadsGeneratorSettingsModel()
            {
