...
{
    public partial class CalendarSpreadsGeneratorSettingsModel : BindableBase, ICalendarSpreadsGeneratorSettings
    {
        ...
        public CalendarSpreadsGeneratorSettingsModel Clone()
        {
            return new CalendarSpreadsGeneratorSettingsModel()
            {
