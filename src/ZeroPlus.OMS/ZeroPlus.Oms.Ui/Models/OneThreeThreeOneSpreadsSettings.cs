...
{
    public partial class OneThreeThreeOneSpreadsSettingsModel : BindableBase, IOneThreeThreeOneSpreadsGeneratorSettings
    {
        ...
        public OneThreeThreeOneSpreadsSettingsModel Clone()
        {
            return new OneThreeThreeOneSpreadsSettingsModel()
            {
