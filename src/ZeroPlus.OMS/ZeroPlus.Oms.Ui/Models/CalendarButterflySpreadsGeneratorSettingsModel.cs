...
{
    public partial class CalendarButterflySpreadsGeneratorSettingsModel : BindableBase, ICalendarButterflySpreadsGeneratorSettings
    {
        ...
        public CalendarButterflySpreadsGeneratorSettingsModel Clone()
        {
            return new CalendarButterflySpreadsGeneratorSettingsModel()
            {
