...
{
    public partial class IronFlySpreadsGeneratorSettingsModel : BindableBase, IIronGutFlySpreadsGeneratorSettings, IIronButterflySpreadsGeneratorSettings
    {
        ...
        public IronFlySpreadsGeneratorSettingsModel Clone()
        {
            return new IronFlySpreadsGeneratorSettingsModel()
            {
