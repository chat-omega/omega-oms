...
public partial class OneThreeTwoSpreadsGeneratorSettingsModel : BindableBase, IOneThreeTwoSpreadsGeneratorSettings
{
    ...
    public OneThreeTwoSpreadsGeneratorSettingsModel Clone()
    {
        return new OneThreeTwoSpreadsGeneratorSettingsModel()
        {
            Reversed = Reversed,
