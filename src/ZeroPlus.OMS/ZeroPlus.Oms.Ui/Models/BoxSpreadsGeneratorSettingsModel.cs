...
public partial class BoxSpreadsGeneratorSettingsModel : BindableBase, IBoxSpreadsGeneratorSettings
{
    ...
    public BoxSpreadsGeneratorSettingsModel Clone()
    {
        return new BoxSpreadsGeneratorSettingsModel()
        {
