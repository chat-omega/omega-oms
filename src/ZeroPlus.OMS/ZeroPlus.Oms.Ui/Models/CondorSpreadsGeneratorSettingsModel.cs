...
{
    public partial class CondorSpreadsGeneratorSettingsModel : BindableBase, ICondorSpreadsGeneratorSettings
    {
        ...
        public CondorSpreadsGeneratorSettingsModel Clone()
        {
            return new CondorSpreadsGeneratorSettingsModel()
            {
