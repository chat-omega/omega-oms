...
namespace ZeroPlus.Models.Data.Structures
{
    public class ExpirationTree
    {
        ...
        public bool ContainsStrike(double strike)
        {
        ...
        public Option? GetClosestStrike(Option option)
        {
            ...
            throw new ApplicationException($"No next best strike found for option: {option}");
        }
        ...
        public Option? GetNextStrikeOption(Option option, PermutationDirection direction)
        {
            ...
            if (sourceIndex == -1)
            {
                ...
                if (sourceIndex == -1)
                {
                    throw new ApplicationException($"No next best strike for option: {option}");
                }
            }
