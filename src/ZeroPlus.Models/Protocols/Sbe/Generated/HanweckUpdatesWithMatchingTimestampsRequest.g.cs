...
{
    /// <summary>
    /// Request Hanweck Updates With Matching Timestamps
    /// </summary>
    public sealed partial class HanweckUpdatesWithMatchingTimestampsRequest
    {
        ...
        private readonly HanweckUpdatesWithMatchingTimestampsRequest _parentMessage;
        ...
        public HanweckUpdatesWithMatchingTimestampsRequest()
        {
            _parentMessage = this;
        }

        public HanweckUpdatesWithMatchingTimestampsRequest WrapForEncode(DirectBuffer buffer, int offset)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public HanweckUpdatesWithMatchingTimestampsRequest WrapForEncodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerEncoder)
        {
        ...
        public HanweckUpdatesWithMatchingTimestampsRequest WrapForDecode(DirectBuffer buffer, int offset, int actingBlockLength, int actingVersion)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public HanweckUpdatesWithMatchingTimestampsRequest WrapForDecodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerDecoder)
        {
        ...
        public sealed partial class SymbolsGroup
        {
            ...
            private HanweckUpdatesWithMatchingTimestampsRequest _parentMessage;
            private DirectBuffer _buffer;
            ...
            public void WrapForDecode(HanweckUpdatesWithMatchingTimestampsRequest parentMessage, DirectBuffer buffer, int actingVersion)
            {
            ...
            public void WrapForEncode(HanweckUpdatesWithMatchingTimestampsRequest parentMessage, DirectBuffer buffer, int count)
            {
                if ((uint) count > 254)
                {
        ...
        public override string ToString()
        {
            ...
            var m = new HanweckUpdatesWithMatchingTimestampsRequest();
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append("[HanweckUpdatesWithMatchingTimestampsRequest](sbeTemplateId=");
            builder.Append(HanweckUpdatesWithMatchingTimestampsRequest.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(HanweckUpdatesWithMatchingTimestampsRequest.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != HanweckUpdatesWithMatchingTimestampsRequest.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(HanweckUpdatesWithMatchingTimestampsRequest.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != HanweckUpdatesWithMatchingTimestampsRequest.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(HanweckUpdatesWithMatchingTimestampsRequest.BlockLength);
            builder.Append("):");
