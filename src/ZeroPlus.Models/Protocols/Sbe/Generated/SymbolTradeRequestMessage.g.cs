...
{
    /// <summary>
    /// Symbol Trade Request Message
    /// </summary>
    public sealed partial class SymbolTradeRequestMessage
    {
        public const ushort BlockLength = (ushort)4;
        public const ushort TemplateId = (ushort)35;
        ...
        private readonly SymbolTradeRequestMessage _parentMessage;
        ...
        public SymbolTradeRequestMessage()
        {
            _parentMessage = this;
        }

        public SymbolTradeRequestMessage WrapForEncode(DirectBuffer buffer, int offset)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public SymbolTradeRequestMessage WrapForEncodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerEncoder)
        {
        ...
        public SymbolTradeRequestMessage WrapForDecode(DirectBuffer buffer, int offset, int actingBlockLength, int actingVersion)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public SymbolTradeRequestMessage WrapForDecodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerDecoder)
        {
        ...
        public override string ToString()
        {
            ...
            var m = new SymbolTradeRequestMessage();
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append("[SymbolTradeRequestMessage](sbeTemplateId=");
            builder.Append(SymbolTradeRequestMessage.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(SymbolTradeRequestMessage.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != SymbolTradeRequestMessage.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(SymbolTradeRequestMessage.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != SymbolTradeRequestMessage.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(SymbolTradeRequestMessage.BlockLength);
            builder.Append("):");
