...
{
    public interface IDiagonalSpreadsGeneratorSettings : ISpreadsGeneratorSettings
    {
        ...
        bool SpreadStrikeSpacingRangeEnabled { get; set; }
        double SpreadStrikeSpacingRangeFloor { get; set; }
        double SpreadStrikeSpacingRangeCeil { get; set; }
        bool SpreadStrikeSpacingListEnabled { get; set; }
        string? SpreadStrikeSpacingList { get; set; }
        ...
        int Leg1Ratio { get; set; }
        int Leg2Ratio { get; set; }
