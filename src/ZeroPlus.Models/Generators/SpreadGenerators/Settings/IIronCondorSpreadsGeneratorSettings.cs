...
{
    public interface IIronCondorSpreadsGeneratorSettings : ISpreadsGeneratorSettings
    {
        ...
        double Leg4DeltaRangeCeil { get; set; }
        bool Leg4DeltaRangeEnabled { get; set; }
        double Leg4DeltaRangeFloor { get; set; }
        double Leg4TheoRangeCeil { get; set; }
        bool Leg4TheoRangeEnabled { get; set; }
        double Leg4TheoRangeFloor { get; set; }
        double Leg4VegaRangeCeil { get; set; }
        bool Leg4VegaRangeEnabled { get; set; }
        double Leg4VegaRangeFloor { get; set; }
        double Leg4WeightedVegaRangeCeil { get; set; }
        bool Leg4WeightedVegaRangeEnabled { get; set; }
        double Leg4WeightedVegaRangeFloor { get; set; }
        double Leg4MarketRangeCeil { get; set; }
        bool Leg4MarketRangeEnabled { get; set; }
        double Leg4MarketRangeFloor { get; set; }
        double Leg4WidthRangeCeil { get; set; }
        bool Leg4WidthRangeEnabled { get; set; }
        double Leg4WidthRangeFloor { get; set; }
        ...
        string? SpreadSpacing3List { get; set; }
        bool SpreadSpacing3ListEnabled { get; set; }
        double SpreadSpacing3RangeCeil { get; set; }
        bool SpreadSpacing3RangeEnabled { get; set; }
        double SpreadSpacing3RangeFloor { get; set; }
        ...
        double Leg4StrikeRangeCeil { get; set; }
        bool Leg4StrikeRangeEnabled { get; set; }
        double Leg4StrikeRangeFloor { get; set; }
