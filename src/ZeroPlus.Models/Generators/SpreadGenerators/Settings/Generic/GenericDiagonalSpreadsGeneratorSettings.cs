...
public class GenericDiagonalSpreadsGeneratorSettings : IDiagonalSpreadsGeneratorSettings
{
    ...
    public bool SpreadStrikeSpacingRangeEnabled { get; set; }
    public double SpreadStrikeSpacingRangeFloor { get; set; }
    public double SpreadStrikeSpacingRangeCeil { get; set; }
    public bool SpreadStrikeSpacingListEnabled { get; set; }
    public string? SpreadStrikeSpacingList { get; set; }
    ...
    public int Leg1Ratio { get; set; }
    public int Leg2Ratio { get; set; }
