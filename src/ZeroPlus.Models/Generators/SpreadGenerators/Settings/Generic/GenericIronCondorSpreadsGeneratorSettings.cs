...
public class GenericIronCondorSpreadsGeneratorSettings : IIronCondorSpreadsGeneratorSettings
{
    ...
    public string? SpreadSpacing3List { get; set; }
    public bool SpreadSpacing3ListEnabled { get; set; }
    public double SpreadSpacing3RangeCeil { get; set; }
    public bool SpreadSpacing3RangeEnabled { get; set; }
    public double SpreadSpacing3RangeFloor { get; set; }
