...
public class SCallTree : IStrategy
{
    public BaseStrategy Strategy => BaseStrategy.CALL_TREE;
    
    public bool TryIdentify(IList<IComplexOrderLegMin> legs, out StrategyIdentification? details)
    {
        details = null;
        
        // Call Tree requires exactly 3 legs, all call options
        ...
        string spreadType = $"TREE {rootSymbols} {expirationDate} {option1.Strike}/{option2.Strike}/{option3.Strike} CALL[{spacing1}]";
