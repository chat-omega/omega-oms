...
public class SPut2x3x1 : IStrategy
{
    public BaseStrategy Strategy => BaseStrategy.PUT_2x3x1;
    
    public bool TryIdentify(IList<IComplexOrderLegMin> legs, out StrategyIdentification? details)
    {
        details = null;
        
        // Put 2x3x1 requires exactly 3 legs, all put options
        ...
        string spreadType = $"TWO THREE ONE {rootSymbols} {expirationDate} {option1.Strike}/{option2.Strike}/{option3.Strike} PUT[{spacing1}/{spacing2}]";
