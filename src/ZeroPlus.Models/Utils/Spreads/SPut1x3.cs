...
public class SPut1x3 : IStrategy
{
    public BaseStrategy Strategy => BaseStrategy.PUT_1X3;
    
    public bool TryIdentify(IList<IComplexOrderLegMin> legs, out StrategyIdentification? details)
    {
        details = null;
        
        // Put 1x3 requires exactly 2 legs, all put options
        ...
        string spreadType = $"PUT 1X3 {rootSymbols} {expirationDate} {option2.Strike}/{option1.Strike}";
        string spreadDescription = $"{(isLongRatio ? "LONG" : "SHORT")} 1X3 RATIO PUT SPREAD {rootSymbols} {expirationDate} {option2.Strike}/{option1.Strike}";
