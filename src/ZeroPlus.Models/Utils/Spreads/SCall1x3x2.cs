...
public class SCall1x3x2 : IStrategy
{
    public BaseStrategy Strategy => BaseStrategy.CALL_1x3x2;
    
    public bool TryIdentify(IList<IComplexOrderLegMin> legs, out StrategyIdentification? details)
    {
        details = null;
        
        // Call 1x3x2 requires exactly 3 legs, all call options
        ...
        string spreadType = $"ONE THREE TWO {rootSymbols} {expirationDate} {option1.Strike}/{option2.Strike}/{option3.Strike} CALL[{spacing1}/{spacing2}]";
